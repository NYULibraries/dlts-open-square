! function() {
    ...
    33: [function(e, t, r) { "use strict";
        ...
        t.exports = function(e, t) {
            ...
            function n(ev) { /* dlts patch: native-select behavior; commit only when released over an option, otherwise close without committing */ var s = ev && ev.target && ev.target.closest ? ev.target.closest('[role="option"]') : null; if (s && "true" !== s.getAttribute("aria-disabled")) { e.setAttribute("aria-activedescendant", s.id), (0, q.default)(e, t, !0), (0, b.default)(e, t) } else { var c = t.querySelector('[aria-selected="true"]'); c && (e.setAttribute("aria-activedescendant", c.id), (0, q.default)(e, t, !0)) } e.focus(), (0, u.default)(t).remove("dqpl-listbox-show"), e.setAttribute("aria-expanded", "false"), document.removeEventListener("mouseup", n), e.addEventListener("blur", r) } var o = new l.default({ ariaLive: "polite" }),
            ...
            a && a.addEventListener("click", function() { return e.focus() }), e.addEventListener("click", function() {
                ...
                e.setAttribute("aria-activedescendant", i.id), (0, q.default)(e, t, !0), document.removeEventListener("mouseup", n), document.addEventListener("mouseup", n) }) } }, { "../../commons/get-label": 10, "./activate": 31, "./arrow": 32, "./open": 36, "./search": 37, "./select": 38, classlist: 68, delegate: 74, "live-region": 78 }],
